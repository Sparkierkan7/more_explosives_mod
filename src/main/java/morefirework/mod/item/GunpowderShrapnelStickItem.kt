...
class GunpowderShrapnelStickItem : Item {
    ...
    override fun use(world: World?, user: PlayerEntity?, hand: Hand?): TypedActionResult<ItemStack> {
        ...
        if (hand == Hand.MAIN_HAND) {
            ...
            var entity = GunpowderShrapnelStickProjectile(world, user as LivingEntity, stack)
    ...
    override fun useOnBlock(context: ItemUsageContext?): ActionResult {
        ...
        if (world.getBlockState(context.blockPos) == MoreFireworkBlocks.FIREWORK_STATION_BLOCK.defaultState) {
            ...
            if (context.hand == Hand.MAIN_HAND) {
                ...
                if (mainStack.item == ItemStack(MorefireworkItems.GUNPOWDER_SHRAPNEL_STICK_ITEM).item) {
