...
import morefirework.mod.MorefireworkMod.Companion.DynamitePackEntityType
...
class DynamitePackProjectile : ThrownItemEntity {
    ...
    constructor(world: World?, owner: LivingEntity, stack: ItemStack?) : super(DynamitePackEntityType, owner, world) {
        ...
        } catch (e: Throwable) { LOGGER.info("Dynamite pack get nbt error: ${e}") }
    ...
    constructor(world: World?, x: Double, y: Double, z: Double) : super(DynamitePackEntityType, x, y, z, world) {
