...
class IncendiaryPackProjectile : ThrownItemEntity {
    ...
    constructor(world: World?, owner: LivingEntity, stack: ItemStack?) : super(IncendiaryPackEntityType, owner, world) {
        ...
        } catch (e: Throwable) { LOGGER.info("Incendiary pack projectile get nbt error: ${e}") }
    ...
    constructor(world: World?, x: Double, y: Double, z: Double) : super(IncendiaryPackEntityType, x, y, z, world) {
