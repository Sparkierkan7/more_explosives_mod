...
class GunpowderBombProjectile : ThrownItemEntity {
    ...
    constructor(world: World?, owner: LivingEntity, stack: ItemStack?) : super(GunpowderBombEntityType, owner, world) {
        ...
        } catch (e: Throwable) { LOGGER.info("Gunpowder bomb get nbt error: ${e}") }
    ...
    constructor(world: World?, x: Double, y: Double, z: Double) : super(GunpowderBombEntityType, x, y, z, world) {
